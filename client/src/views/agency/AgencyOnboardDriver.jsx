...
export default function AgencyOnboardDriver() {
    ...
    <div className="max-w-4xl mx-auto space-y-6 animate-in fade-in duration-200">
      ...
      <div className="flex items-center justify-between">
        <div className="flex items-center gap-3">
          <BackButton onClick={() => setActiveView('agency_drivers')} label="Back to Fleet Drivers" />
          <div>
            <h1 className="text-2xl font-black text-slate-900">Onboard Carrier Driver & Commercial Verification</h1>
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div className="pt-4 flex items-center justify-end gap-3 border-t border-slate-100">
              <Button
                variant="secondary"
                size="md"
                onClick={() => setActiveView('agency_drivers')}
              >
                Cancel
              </Button>
              ...
              <Button
                ...
                icon={CheckCircle2}
              >
                {isSubmitting ? 'Verifying...' : 'Verify & Onboard Driver'}
              </Button>
            </div>
